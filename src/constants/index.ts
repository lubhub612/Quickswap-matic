...
export const GlobalConst = {
  ...
  addresses: {
    ROUTER_ADDRESS: {
      ...
      [ChainId.MUMBAI]: '0x7672011e9B3A1a96f03FFC769c03279A8a75CA57',
    ...
    FACTORY_ADDRESS: '0x9DAcc3749f1675D5a1944a2eA171a801B9d09051',
...
export const GlobalValue = {
  ...
  tokens: {
    ...
    COMMON: {
      ...
      Hlal: new Token(
        ChainId.MUMBAI,
        '0x8767695742B63c55b1B0A69eb2D5764eFB5Af883',
        18,
        'Hlal',
        'Halal Token',
      ),
